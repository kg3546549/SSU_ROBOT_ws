...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(PatrolParamConfig::AbstractParamDescriptionConstPtr(new PatrolParamConfig::ParamDescription<int>("Command", "int", 0, "A size parameter which is edited via an enum", "{'enum_description': 'An enum to set size', 'enum': [{'srcline': 18, 'description': 'first data', 'srcfile': '/home/yahboom/SSU_ROBOT_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'LengthTest'}, {'srcline': 19, 'description': 'two data', 'srcfile': '/home/yahboom/SSU_ROBOT_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'AngleTest'}, {'srcline': 20, 'description': 'three datat', 'srcfile': '/home/yahboom/SSU_ROBOT_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Triangle'}, {'srcline': 21, 'description': 'four data', 'srcfile': '/home/yahboom/SSU_ROBOT_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'Square'}, {'srcline': 22, 'description': 'five data', 'srcfile': '/home/yahboom/SSU_ROBOT_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'Circle'}, {'srcline': 23, 'description': 'six data', 'srcfile': '/home/yahboom/SSU_ROBOT_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg', 'cconsttype': 'const int', 'value': 5, 'ctype': 'int', 'type': 'int', 'name': 'Parallelogram'}]}", &PatrolParamConfig::Command)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
