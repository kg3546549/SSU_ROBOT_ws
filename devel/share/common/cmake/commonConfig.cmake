...
if("TRUE" STREQUAL "TRUE")
  set(common_SOURCE_PREFIX /home/jetson/SSU_Robot_ws/SSU_ROBOT_ws/src/common)
  set(common_DEVEL_PREFIX /home/jetson/SSU_Robot_ws/SSU_ROBOT_ws/devel)
  set(common_INSTALL_PREFIX "")
  set(common_PREFIX ${common_DEVEL_PREFIX})
else()
  set(common_SOURCE_PREFIX "")
  set(common_DEVEL_PREFIX "")
  set(common_INSTALL_PREFIX /home/jetson/SSU_Robot_ws/SSU_ROBOT_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'KG <kg354654932@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jetson/SSU_Robot_ws/SSU_ROBOT_ws/src/common/${idir}'.  ${_report}")
    endif()
